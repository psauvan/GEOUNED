...
from OCP.gp import gp_Ax1, gp_Ax2, gp_Ax3, gp_Dir, gp_Pnt, gp_Pnt2d, gp_Trsf, gp_Vec
...
class GSolid:
    ...
    def fix(self, tolerance: float) -> "GSolid":
        unify = ShapeUpgrade_UnifySameDomain(self.__native__, UnifyEdges=True, UnifyFaces=True, ConcatBSplines=True)
        unify.Build()
        shape = unify.Shape()
