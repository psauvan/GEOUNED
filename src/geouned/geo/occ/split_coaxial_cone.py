...
BOP split. See CLAUDE.md's "Gsplit's coaxial cone fallback" section.
...
circular; both sides are only resolved once whichever module is
imported first has finished loading.
"""
