"""
geo/occ/_native_utils.py

Native-conversion helpers and kernel provenance -- split out of the
former monolithic _occ_impl.py (2026-08-30), grouped by function
alongside its freecad/ocp siblings of the same name.
"""
...
def _unimplemented(name):
    def _raise(*args, **kwargs):
        raise NotImplementedError(f"geo.occ.{name} is not implemented yet.")
